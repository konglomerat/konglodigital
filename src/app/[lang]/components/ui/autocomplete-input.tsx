    ...
    return (
      <ComboboxInput
        ...
        renderOption={(option, { active }) =>
          option.type === "suggestion" ? (
            // Dieselbe Zeile wie in der Liste des Design Systems:
            // Name links, Kennung rechts in Fira Mono.
            <div
              className={`flex cursor-pointer items-baseline justify-between gap-2.5 px-3 py-1.5 ${
                active ? "bg-primary-soft" : ""
              }`}
            >
              <span>{option.suggestion.name}</span>
            ...
            <div
              className={`cursor-pointer px-3 py-1.5 text-primary ${
                active ? "bg-primary-soft" : ""
              }`}
            >
              ...
              <span>&bdquo;{option.name}&ldquo;</span>
            </div>
          )
        }
      />
