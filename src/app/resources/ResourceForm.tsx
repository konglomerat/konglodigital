  ...
  return (
    <form className="grid gap-4 md:grid-cols-2" onSubmit={onSubmit}>
      <div className="flex flex-col gap-2">
        <label className={themeStyles.label}>Name</label>
        <input
          type="text"
          {...register("name", {
            required: requireName ? "Name is required." : false,
          })}
      ...
      <div className="flex flex-col gap-2">
        <label className={themeStyles.label}>Type</label>
        <select
      ...
      <div className="flex flex-col gap-2">
        <label className={themeStyles.label}>Priority</label>
        {priorityInput === "stars" ? (
          <>
            <input
              type="hidden"
      ...
      <div className="flex flex-col gap-2 md:col-span-2">
        <label className={themeStyles.label}>Description</label>
        <textarea
      ...
      <div className="flex flex-col gap-2 md:col-span-2">
        <label className={themeStyles.label}>Tags</label>
        <input
          type="text"
          {...register("tags")}
          className={themeStyles.input}
      ...
      <div className="flex flex-col gap-2 md:col-span-2">
        <label className={themeStyles.label}>Related resources</label>
        ...
        <Select<RelatedResourceSelectOption, true>
          ...
          placeholder="Search and select related resources"
      ...
      {onGpsChange ? (
        <div className="flex flex-col gap-2 md:col-span-2">
          <label className={themeStyles.label}>Location</label>
          ...
          {gpsSuggested ? (
            <p className={themeStyles.fileHelp}>
              We detected a location from the image. Please confirm or adjust it
              on the map.
            </p>
          ) : null}
          <p className={themeStyles.fileHelp}>
            Drag the marker or click the map to set the location.
          </p>
        </div>
      ) : null}
